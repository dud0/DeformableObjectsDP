 ...
 */
    ...
    // utility function
    void randomizeBodies(int *numEdges, NBodyConfig config, float* pos, float* vel, float *force, float *forces, float* color, float clusterScale,
    ...
    protected: // methods
        ...
        virtual void _initialize(int numBodies, int numEdges) = 0;
